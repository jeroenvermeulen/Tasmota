...
Max72xxPanel::Max72xxPanel(int8_t csPin, uint8_t hDisplays, uint8_t vDisplays) : Renderer(hDisplays << 3, vDisplays << 3) {
...
#ifdef SOFTSPI
Max72xxPanel::Max72xxPanel(int8_t csPin, int8_t mosiPin, int8_t sclkPin, uint8_t hDisplays, uint8_t vDisplays) : Renderer(hDisplays << 3, vDisplays << 3) {
  Max72xxPanel::SPI_CS = csPin;
